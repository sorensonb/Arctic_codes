...
int main(int argc, char *argv[]) {
    ...
    char avg_file_start[] = "/home/blake.sorenson/MISR/misr_avg_aod_newData";
                    ...
                    while((de_2=readdir(dr_2)) != NULL)
                    {
                        ...
                        if(s2len>2)
                        {
                            ...
                            for(i=0;i<max_index;i++)
                            {
                                ...
                                //if(strcmp(file_name,"/data/MISR/l5ftl01.larc.nasa.gov/misrl2l3/MISR/MIL2ASAE.003/2000.03.14/MISR_AM1_AS_AEROSOL_P009_O001272_F13_0023.nc")==0)
                                ...
                                if((aod_raw[i]>-900.0) & 
                                   (lat[i] > -200) & (lon[i] > -300))
                                {
                                    lat_index = (int)floor(lat[i]*(1./grid_resolution) - lat_gridder)+90;
                                    lon_index = (int)floor(lon[i])+180;
