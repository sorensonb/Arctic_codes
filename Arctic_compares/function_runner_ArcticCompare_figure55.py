...
#    use_correct_error_calc = True, add_spplmnt_files = False, \
#    #excluded_months = [4,5], \
...
num_bins = 200
#astrofit = True
#plot_NN_error_dist_bulk('noland105', ax = ax1, num_bins = num_bins, \
#    astrofit = astrofit, \
#    xmin = -100, xmax = 100, \
...
# --------------------------
errors = test_dict['calc_swf'] - test_dict['ceres_swf']
hist = ax1.hist(errors, bins = num_bins)
