subroutine read_comp_MODIS_COD(file_id)
!
! NAME:
!   read_comp_MODIS_COD
!
...
!  ############################################################################
  ...
  use hdf5
  use colocate_vars, only : MODIS_COD_dims, MODIS_COD_data
  ...
  call h5dopen_f(file_id, 'cod', ds_id, error)
...
end subroutine read_comp_MODIS_COD
