subroutine read_comp_CERES_SWF(file_id)
!
! NAME:
!   read_comp_AI
!
...
!  ############################################################################
  ...
  use hdf5
  use colocate_vars, only : CERES_SWF_dims, CERES_SWF_data
  ...
  call h5dopen_f(file_id, 'swf', ds_id, error)
...
end subroutine read_comp_CERES_SWF
