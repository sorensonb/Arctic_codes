subroutine read_comp_CERES_CLD(file_id)
!
! NAME:
!   read_comp_AI
!
...
!  ############################################################################
  ...
  use hdf5
  use colocate_vars, only : CERES_CLD_dims, CERES_CLD_data
  ...
  call h5dopen_f(file_id, 'cld', ds_id, error)
...
end subroutine read_comp_CERES_CLD
