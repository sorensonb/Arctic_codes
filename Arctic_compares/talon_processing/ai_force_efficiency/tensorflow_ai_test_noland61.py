...
if(l_load_model):
    ...
    drop_layer1    = Dropout(0.20, name = 'drop1')(hidden_layer3)
    hidden_layer4  = Dense(units = 24, activation = 'leaky_relu', name = 'hidden4')(drop_layer1)
    ...
    drop_layer2    = Dropout(0.20, name = 'drop2')(hidden_layer8)
    hidden_layer9  = Dense(units = 16, activation = 'leaky_relu', name = 'hidden9')(drop_layer2)
