...
if(l_load_model):
    ...
    hidden_layer1  = Dense(units = 20, activation = 'leaky_relu', name = 'hidden1')(input_layer)
    hidden_layer2  = Dense(units = 24, activation = 'leaky_relu', name = 'hidden2')(hidden_layer1)
    hidden_layer3  = Dense(units = 28, activation = 'leaky_relu', name = 'hidden3')(hidden_layer2)
    hidden_layer4  = Dense(units = 32, activation = 'leaky_relu', name = 'hidden4')(hidden_layer3)
    hidden_layer5  = Dense(units = 36, activation = 'leaky_relu', name = 'hidden5')(hidden_layer4)
    hidden_layer6  = Dense(units = 40, activation = 'leaky_relu', name = 'hidden6')(hidden_layer5)
    hidden_layer7  = Dense(units = 44, activation = 'leaky_relu', name = 'hidden7')(hidden_layer6)
    hidden_layer8  = Dense(units = 48, activation = 'leaky_relu', name = 'hidden8')(hidden_layer7)
    hidden_layer9  = Dense(units = 44, activation = 'leaky_relu', name = 'hidden9')(hidden_layer8)
    hidden_layer10 = Dense(units = 40, activation = 'leaky_relu', name = 'hidden10')(hidden_layer9)
    hidden_layer11 = Dense(units = 36, activation = 'leaky_relu', name = 'hidden11')(hidden_layer10)
    hidden_layer12 = Dense(units = 32, activation = 'leaky_relu', name = 'hidden12')(hidden_layer11)
    hidden_layer13 = Dense(units = 28, activation = 'leaky_relu', name = 'hidden13')(hidden_layer12)
    hidden_layer14 = Dense(units = 24, activation = 'leaky_relu', name = 'hidden14')(hidden_layer13)
    hidden_layer15 = Dense(units = 20, activation = 'leaky_relu', name = 'hidden15')(hidden_layer14)
    hidden_layer16 = Dense(units = 16, activation = 'leaky_relu', name = 'hidden16')(hidden_layer15)
    hidden_layer17 = Dense(units = 8, activation = 'leaky_relu', name = 'hidden17')(hidden_layer16)
    hidden_layer18 = Dense(units = 4, activation = 'leaky_relu', name = 'hidden18')(hidden_layer17)
    prediction = Dense(1, activation = 'linear')(hidden_layer18)
