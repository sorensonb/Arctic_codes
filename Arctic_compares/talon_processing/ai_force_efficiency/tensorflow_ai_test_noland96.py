...
if(l_load_model):
    ...
    hidden_layer1  = Dense(units = 8,  activation = hidden_act, name = 'hidden1')(input_layer)
    hidden_layer2  = Dense(units = 12, activation = hidden_act, name = 'hidden2')(hidden_layer1)
    hidden_layer3  = Dense(units = 16, activation = hidden_act, name = 'hidden3')(hidden_layer2)
    hidden_layer4  = Dense(units = 24, activation = hidden_act, name = 'hidden4')(hidden_layer3)
    hidden_layer5  = Dense(units = 32, activation = hidden_act, name = 'hidden5')(hidden_layer4)
    hidden_layer6  = Dense(units = 64, activation = hidden_act, name = 'hidden6')(hidden_layer5)
    hidden_layer7  = Dense(units = 32, activation = hidden_act, name = 'hidden7')(hidden_layer6)
    hidden_layer8  = Dense(units = 24, activation = hidden_act, name = 'hidden8')(hidden_layer7)
    hidden_layer9  = Dense(units = 16, activation = hidden_act, name = 'hidden9')(hidden_layer8)
    hidden_layer10 = Dense(units = 12, activation = hidden_act, name = 'hidden10')(hidden_layer9)
    hidden_layer11 = Dense(units = 8,  activation = hidden_act, name = 'hidden11')(hidden_layer10)
    ...
    drange = min_max_dict['ceres_swf']['max'] - min_max_dict['ceres_swf']['min']
    print(  ((combined_data['ceres_swf'][test_idxs][0:10]) * drange) + min_max_dict['ceres_swf']['min'])
    print(  ((test_out) * drange) + min_max_dict['ceres_swf']['min'])
...
if(l_save_data):
    ...
    #for infile in clear_file_list:
        ...
        new_sza = ( ( data['omi_sza'][:,:] - min_max_dict['omi_sza']['min']) / \
                    ( min_max_dict['omi_sza']['max'] - min_max_dict['omi_sza']['min'] ))
        new_vza = ( ( data['omi_vza'][:,:] - min_max_dict['omi_vza']['min']) / \
                    ( min_max_dict['omi_vza']['max'] - min_max_dict['omi_vza']['min'] ))
        new_ice = ( ( local_ice - min_max_dict['nsidc_ice']['min']) / \
                    ( min_max_dict['nsidc_ice']['max'] - min_max_dict['nsidc_ice']['min'] ))
        new_cod = ( ( data['modis_cod'][:,:] - min_max_dict['modis_cod']['min']) / \
                    ( min_max_dict['modis_cod']['max'] - min_max_dict['modis_cod']['min'] )) 
        #new_ch1 = ( ( data['modis_ch1'][:,:] - min_max_dict['modis_ch1']['min']) / \
        #            ( min_max_dict['modis_ch1']['max'] - min_max_dict['modis_ch1']['min'] ))
        new_ch7 = ( ( data['modis_ch7'][:,:] - min_max_dict['modis_ch7']['min']) / \
                    ( min_max_dict['modis_ch7']['max'] - min_max_dict['modis_ch7']['min'] ))
        new_cpr = ( ( local_cldpres - min_max_dict['modis_cld_top_pres']['min']) / \
                    ( min_max_dict['modis_cld_top_pres']['max'] - min_max_dict['modis_cld_top_pres']['min'] ))
        new_alb = ( ( data['ceres_alb'][:,:] - min_max_dict['ceres_alb']['min']) / \
                    ( min_max_dict['ceres_alb']['max'] - min_max_dict['ceres_alb']['min'] ))

        # Set the bad pixels to valid numbers for now to use in the calculation,
        # but mask these indices after the calculation
        # ----------------------------------------------------------------------
        new_sza[data_mask.mask] = 0.5
        new_vza[data_mask.mask] = 0.5
        new_ice[data_mask.mask] = 0.5
        new_cod[data_mask.mask] = 0.5
        new_ch7[data_mask.mask] = 0.5
        new_cpr[data_mask.mask] = 0.5
        new_alb[data_mask.mask] = 0.5
