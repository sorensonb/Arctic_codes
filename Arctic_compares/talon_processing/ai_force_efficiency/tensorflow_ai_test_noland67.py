...
if(l_load_model):
    ...
    hidden_layer5  = Dense(units = 40, activation = 'leaky_relu', name = 'hidden5')(hidden_layer4)
    hidden_layer6  = Dense(units = 48, activation = 'leaky_relu', name = 'hidden6')(hidden_layer5)
    hidden_layer7  = Dense(units = 56, activation = 'leaky_relu', name = 'hidden7')(hidden_layer6)
    hidden_layer8  = Dense(units = 64, activation = 'leaky_relu', name = 'hidden8')(hidden_layer7)
    hidden_layer9  = Dense(units = 56, activation = 'leaky_relu', name = 'hidden9')(hidden_layer8)
    hidden_layer10 = Dense(units = 48, activation = 'leaky_relu', name = 'hidden10')(hidden_layer9)
    hidden_layer11 = Dense(units = 40, activation = 'leaky_relu', name = 'hidden11')(hidden_layer10)
    ...
    hidden_layer14 = Dense(units = 16, activation = 'leaky_relu', name = 'hidden14')(hidden_layer13)
    hidden_layer15 = Dense(units = 12, activation = 'leaky_relu', name = 'hidden15')(hidden_layer14)
    hidden_layer16 = Dense(units = 8, activation = 'leaky_relu', name = 'hidden16')(hidden_layer15)
    hidden_layer17 = Dense(units = 4, activation = 'leaky_relu', name = 'hidden17')(hidden_layer16)
    prediction = Dense(1, activation = 'linear')(hidden_layer17)
