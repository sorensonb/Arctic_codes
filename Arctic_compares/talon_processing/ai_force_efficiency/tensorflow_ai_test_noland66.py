...
if(l_load_model):
    ...
    hidden_layer1  = Dense(units = 12, activation = 'leaky_relu', name = 'hidden1')(input_layer)
    hidden_layer2  = Dense(units = 16, activation = 'leaky_relu', name = 'hidden2')(hidden_layer1)
