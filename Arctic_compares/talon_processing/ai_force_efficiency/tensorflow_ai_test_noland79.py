...
if(l_load_model):
    ...
    hidden_layer1  = Dense(units = 8,  activation = 'linear', name = 'hidden1')(input_layer)
    hidden_layer2  = Dense(units = 12, activation = 'linear', name = 'hidden2')(hidden_layer1)
    hidden_layer3  = Dense(units = 16, activation = 'linear', name = 'hidden3')(hidden_layer2)
    hidden_layer4  = Dense(units = 24, activation = 'linear', name = 'hidden4')(hidden_layer3)
    hidden_layer5  = Dense(units = 32, activation = 'linear', name = 'hidden5')(hidden_layer4)
    hidden_layer6  = Dense(units = 64, activation = 'linear', name = 'hidden6')(hidden_layer5)
    hidden_layer7  = Dense(units = 32, activation = 'linear', name = 'hidden7')(hidden_layer6)
    hidden_layer8  = Dense(units = 24, activation = 'linear', name = 'hidden8')(hidden_layer7)
    hidden_layer9  = Dense(units = 16, activation = 'linear', name = 'hidden9')(hidden_layer8)
    hidden_layer10 = Dense(units = 12, activation = 'linear', name = 'hidden10')(hidden_layer9)
    hidden_layer11 = Dense(units = 8,  activation = 'linear', name = 'hidden11')(hidden_layer10)
