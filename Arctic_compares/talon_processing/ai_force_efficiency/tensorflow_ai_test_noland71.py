...
#           16,24,32,40,48,56,64,72,80,88,80,72,64,56,48,40,32,24,16,8 nodes in each layer
    ...
    hidden_layer11 = Dense(units = 96, activation = 'leaky_relu', name = 'hidden11')(hidden_layer10)
    hidden_layer12 = Dense(units = 88, activation = 'leaky_relu', name = 'hidden12')(hidden_layer11)
    hidden_layer13 = Dense(units = 80, activation = 'leaky_relu', name = 'hidden13')(hidden_layer12)
    hidden_layer14 = Dense(units = 72, activation = 'leaky_relu', name = 'hidden14')(hidden_layer13)
    hidden_layer15 = Dense(units = 64, activation = 'leaky_relu', name = 'hidden15')(hidden_layer14)
    hidden_layer16 = Dense(units = 56, activation = 'leaky_relu', name = 'hidden16')(hidden_layer15)
    hidden_layer17 = Dense(units = 48, activation = 'leaky_relu', name = 'hidden17')(hidden_layer16)
    hidden_layer18 = Dense(units = 40, activation = 'leaky_relu', name = 'hidden18')(hidden_layer17)
    hidden_layer19 = Dense(units = 32, activation = 'leaky_relu', name = 'hidden19')(hidden_layer18)
    hidden_layer20 = Dense(units = 24, activation = 'leaky_relu', name = 'hidden20')(hidden_layer19)
    hidden_layer21 = Dense(units = 16, activation = 'leaky_relu', name = 'hidden21')(hidden_layer20)
    hidden_layer22 = Dense(units = 8, activation = 'leaky_relu', name = 'hidden22')(hidden_layer21)
    prediction = Dense(1, activation = 'linear')(hidden_layer22)
