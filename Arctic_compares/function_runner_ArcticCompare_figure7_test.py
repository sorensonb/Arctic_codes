...
#ice_bin_edges = np.array([5, 25, 45, 65, 85, 100.2, 255])    # 20-deg bins, 65 center
#ice_bin_edges = np.array([5, 20, 35, 50, 65, 80, 95])        # 15-deg bins, 65 center
#ice_bin_edges = np.array([0, 15, 30, 45, 60, 75, 90])        # 15-deg bins, 60 center
#ice_bin_edges = np.array([20, 30, 40, 50, 60, 70, 80])       # 10-deg bins, 60 center
#ice_bin_edges = np.array([25, 35, 45, 55, 65, 75, 85])       # 10-deg bins, 65 center
#ice_bin_edges = np.array([40, 45, 50, 55, 60, 65, 70])       # 5-deg bins,  60 center
