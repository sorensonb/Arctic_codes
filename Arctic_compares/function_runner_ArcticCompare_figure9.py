...
#sys.exit()
#plot_grid_OMI_climo_spatial(shawn_file, min_AI = -2.00, \
#    max_AI = 20.0, minlat = 65.5, maxlat = 90.5,  save = False)
#sys.exit()

#  # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
#
# For making Figure 9 from (version 7) of the Arctic direct radiative 
# forcing paper. Running with filter_bad_vals set to False. 
#
# The average monthly climo value for OMI_daily_VSJ4 with min_AI = -20 and
# max_AI = 0.5 are between -0.3 and -0.2. 
#
# In test_calculate_type_forcing_v4, forcing is calculated at a box
# if the difference between the daily AI value and the clean-sky
# background (OMI_daily_VSJ4) is greater than the ai_thresh value
# of 0.7.
#
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
#  # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
