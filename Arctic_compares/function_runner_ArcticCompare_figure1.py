...
plot_compare_OMI_MODIS_NSIDC_v3_combined(sys.argv[1], sys.argv[2], \
...
date_str1 = '201408112211'
date_str2 = '201807052213'
ch1 = 'true_color'
plot_compare_OMI_MODIS_NSIDC_v2_combined(date_str1, date_str2, ch1, \
