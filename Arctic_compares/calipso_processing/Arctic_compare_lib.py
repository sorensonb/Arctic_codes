...
def automate_all_preprocess(date_str, download = True, images = True, \
    ...
    if(omi_dtype == 'shawn'):
        ...
        shawn_path = '/data1/OMI/shawn_files/'
    elif(omi_dtype == 'ltc3'):
        omi_dtype = 'shawn'
        omi_dtype2 = 'ltc3'
...
def single_wrap_function(date_str, minlat, min_AI, out_time_dict, download, \
    ...
    # Remove any times that are also in skiptimes
    # -------------------------------------------
    if(skiptimes is not None):
        for ttime in skiptimes:
            if(ttime in good_list):
                good_list.remove(ttime)
    ...
    if(run_list is not None):
        ...
        for date_str in run_list:
            ...
            single_wrap_function(date_str, minlat, min_AI, out_time_dict, \
                ...
                reprocess_only_omi, skiprows = skiprows, skiptimes = skiptimes)
    else:
...
def auto_all_download(date_str, download = True, rewrite_json = False, \
    ...
    if(omi_dtype == 'shawn'):
        ...
        omi_dtype2 = 'ltc3'
        #shawn_path = home_dir+ '/data/OMI/shawn_files/ltc3/'
        shawn_path = '/data1/OMI/shawn_files/new/'
    ...
    for dstr in date_str:
        ...
        if(dstr not in out_time_dict.keys() or rewrite_json):
            ...
            ##!#    '/Research/NSIDC/NSIDC0051_SEAICE_PS_N25km_' + \
