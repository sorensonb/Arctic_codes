subroutine read_comp_TROP_AI(file_id)
!
! NAME:
!   read_comp_TROP_AI
!
...
!  ############################################################################
  ...
  use hdf5
  use colocate_vars, only : TROP_AI_dims, TROP_AI_data
  ...
  call h5dopen_f(file_id, 'trop_ai', ds_id, error)
...
end subroutine read_comp_TROP_AI
