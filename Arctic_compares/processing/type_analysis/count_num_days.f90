subroutine count_num_days(file_name_file, i_num_swath, i_num_days)
!
! NAME:
!   count_num_days.f90
!
...
!  ############################################################################
  ...
  character(len = 12)    :: single_file_date        ! dtg from each line of file
  ...
  if(istatus > 0) then
    ...
    file_loop: do
      ...
      if(istatus < 0) then 
        ...
        !write(*,*) single_file_date, i_int_day, i_current_day
