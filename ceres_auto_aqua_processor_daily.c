...
int main(int argc, char *argv[]) {
    ...
    char      avg_file_start[] = "/home/bsorenson/HighLatitudeStudy/CERES/average_files/AQUA/daily_averages/clr_pcnt_limit/ceres_daily_avg_gridded_values_";
    ...
    while(i<27)
    {
        if(strcmp(month_check,fm4_dates[i])==0)
        {
            fm4_check=i;
            i=27;
        }
