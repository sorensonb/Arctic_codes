...
massey_file = 'massey_composite_postseason_2022.txt'
...
def set_preseason_rankings(gdict, rank_file = massey_file, \
    ...
    massey_ranks = read_poll_ranks(infile = massey_file)
...
def read_poll_ranks(infile = massey_file):
    massey_dict = {}
